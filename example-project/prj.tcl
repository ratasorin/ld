# the project name needs to be used inside the "how_to_run.sh" file
project_new example-project -overwrite
...
set_global_assignment -name SDC_FILE example-project.sdc
